...
import { UnifiedDataPoint, AgentPerformance, WrapUpData, BranchData, CallerData, ReasonBranchData, CustomerConversation, InteractionRecord } from './types';
import { 
...
const App: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Secondary data for charts (fallback values if not provided by reduced metrics)
              ...
              <form onSubmit={handleConnect} className="space-y-6">
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all" 
                  />
                </div>
                ...
                <button type="submit" className="w-full py-4 bg-emerald-500 hover:bg-emerald-600 text-white font-black rounded-xl transition-all shadow-lg shadow-emerald-500/20 active:scale-[0.98] flex items-center justify-center gap-3">
                  ...
                  <span className="uppercase tracking-widest">Connect Mawsool</span>
                </button>
