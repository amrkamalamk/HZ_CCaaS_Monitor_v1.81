...
// Dynamic imports for charts to ensure compatibility
...
const App: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    orgName: GENESYS_ORG_DEFAULT,
    region: GENESYS_REGION_DEFAULT, 
    queueName: QUEUE_NAME_DEFAULT, 
    proxyUrl: DEFAULT_PROXY, 
    threshold: MOS_THRESHOLD_DEFAULT,
  });
